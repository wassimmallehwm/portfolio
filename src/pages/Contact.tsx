  ...
  return (
    <div id="contact" className='w-full h-screen bg-slate-100 text-primary flex justify-center items-center p-4'>
        <form method='POST' action='https://getform.io/f/1b021e68-09a4-47b9-bf07-7657a14c9ba7' className='flex flex-col max-w-[600px] w-full'>
            ...
            <textarea className='m-3 px-4 py-2 rounded-md border-2 border-primary_shadow_light focus:border-primary_blur focus:outline-none' name="message" rows={10} placeholder='Message'></textarea>
